...
class TaskCardBikroy extends StatefulWidget {
  var imgCard;
  var titleCard;
  var title1Card;
  var title2Card;
  ...
  @override
  _TaskCardBikroyState createState() => _TaskCardBikroyState();
}

class _TaskCardBikroyState extends State<TaskCardBikroy> {
  @override
