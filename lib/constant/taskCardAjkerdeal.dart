...
class TaskCardAjkerdeal extends StatefulWidget {
  var imgCard;
  var titleCard;
  var title1Card;
  var title2Card;
  ...
  @override
  _TaskCardAjkerdealState createState() => _TaskCardAjkerdealState();
}

class _TaskCardAjkerdealState extends State<TaskCardAjkerdeal> {
  @override
