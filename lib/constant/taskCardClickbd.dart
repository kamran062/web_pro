...
class TaskCardClickbd extends StatefulWidget {
  var imgCard;
  var titleCard;
  var title1Card;
  var title2Card;
  ...
  @override
  _TaskCardClickbdState createState() => _TaskCardClickbdState();
}

class _TaskCardClickbdState extends State<TaskCardClickbd> {
  @override
